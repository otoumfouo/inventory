...
var switchFunctionality = {
    ...
    setMode: function() {
        ...
        if (Cookies.getCookie('dark_mode') != "") {
            ...
            if(imgLogo) {
                imgLogo.setAttribute('src', '/static/cork/dark/assets/img/90x90.jpg');
            }
            ...
            for (var i = 0; i < linkElement.length; i++) {
                ...
                if( getHref == "/static/cork/dark/assets/css/loader.css" ) {
                } else {

                    if(n) {
                        linkElement[i].setAttribute('href', getHref);
                    } else {
                        setHref = getHref.split('/')
                        Href = ''
                        for(var j=0; j<setHref.length; j++){
                            Src += setHref[j]+'/'
                            if(j==2){
                              Src += 'dark/'
                            }
                        ...
                        console.log(Href)
                        linkElement[i].setAttribute('href', '' + Href);
                    }
                }
            }
            ...
            for (var i = 0; i < scriptElement.length; i++) {
                ...
                console.log(Src)
                if( getSrc == "/static/cork/dark/assets/js/loader.js" ) {
                } else {
                    scriptElement[i].setAttribute('src', '' + Src);
                }
            }
